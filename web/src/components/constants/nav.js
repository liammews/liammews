    ...
    <nav className="flex items-center lg:justify-center flex-wrap pl-4 pt-2 lg:pb-4 fixed w-full lg:static border-b border-gray-300 bg-white dark:bg-gray-800 bg-opacity-80 bg-blur-light">
      ...
      <div className="flex flex-row pb-12 pl-2">
                    <ul className="flex flex-row space-x-8 items-end">
                        ...
                        <li className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 text-lg"><a href="https://twitter.com/liammews"><FaBehance /></a></li>
                        <li className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 text-lg"><a href="https://twitter.com/liammews"><FaGithub /></a></li>
                    </ul>
                </div>
      </div>
